...
class LoginMobileUi extends StatefulWidget {
  ...
  @override
  State<LoginMobileUi> createState() => _MobileAuth_UIState();
}

class _MobileAuth_UIState extends State<LoginMobileUi> {
  ...
  //  await  Navigator.pushNamed(context, '/otpScreen', arguments: '+918051208207');
